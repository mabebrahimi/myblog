...
const PortfolioPage = async () => {
  const res = await fetch('https://aliebrahimi.me/ghost/api/v3/content/pages/?key=26da1f3f23d488dba960b2f337&filter=tag:portfolio', { next: { tags: ['portfolio'] } })
  ...
  return (
    <>
      ...
      <LatestProject portfolios={portfolios.pages?.reduce((a: any, b: any) => {
        return dayjs(b.published_at).diff(dayjs(a.published_at));
      })} />

      <AllProjects portfolios={portfolios} />
      <Cta
